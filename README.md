...
Hadiest là một trợ lý ảo thông minh đa phương thức, được thiết kế để trở thành một người bạn tâm sự và chuyên gia gợi ý âm nhạc Việt Nam. Dự án kết hợp sức mạnh của các mô hình ngôn ngữ lớn (LLM) với khả năng xử lý âm thanh kỹ thuật số để mang lại trải nghiệm tương tác tự nhiên và trực quan.
🌟 Tính năng nổi bật
